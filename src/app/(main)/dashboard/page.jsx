      ...
      <main className="w-full p-4 sm:p-6 lg:p-8 space-y-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          ...
          <motion.button
            ...
            className="self-start sm:self-auto px-5 py-3 rounded-2xl br-linear-to-r from-emerald-600 via-teal-600 to-lime-600 text-white font-black text-xs sm:text-sm shadow-md shadow-emerald-600/25 hover:shadow-emerald-500/40 transition-all flex items-center gap-2 cursor-pointer shrink-0"
          >
          ...
          <div className="p-5 sm:p-6 rounded-3xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-lg flex flex-col justify-between relative overflow-hidden">
            <div>
              ...
              <div className="my-4 p-4 rounded-2xl bg-emerald-500/5 dark:bg-emerald-500/10 border border-emerald-500/20 text-center">
                ...
                <div className="text-4xl sm:text-5xl font-black text-transparent bg-clip-text br-linear-to-r from-emerald-500 to-lime-500 my-1">
                  Token #47
                </div>
        ...
        <div className="p-5 sm:p-6 rounded-3xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-md">
          <div className="flex items-center justify-between pb-3 border-b border-slate-100 dark:border-slate-800 mb-4">
            ...
            <span className="text-[10px] font-bold bg-amber-500/10 text-amber-600 dark:text-amber-400 px-2.5 py-1 rounded-full border border-amber-500/20">
              Phase 3 Active
            </span>
          </div>
        ...
        <div className="p-5 sm:p-6 rounded-3xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-md">
          ...
          <div className="grid md:grid-cols-3 gap-4">
            {NEARBY_CENTRES.map((centre) => (
              <div
                key={centre.id}
                className="p-4 rounded-2xl bg-slate-50 dark:bg-slate-800/50 border border-slate-200 dark:border-slate-700/70 hover:border-emerald-500/40 transition-all flex flex-col justify-between"
              >
                <div>
                  ...
                  <div className="space-y-1.5 text-xs mt-3">
                    ...
                    <div className="flex justify-between text-slate-600 dark:text-slate-300">
                      ...
                      <strong className="text-amber-500">{centre.wait}</strong>
                    </div>
        ...
        {showAppointmentModal && (
          <div className="fixed inset-0 z-150 flex items-center justify-center p-4 bg-black/70 backdrop-blur-sm">
            ...
            >
              ...
              <h3 className="text-base font-black">Gate Pass & Appointment</h3>
        ...
        {showTrackQueueModal && (
          <div className="fixed inset-0 z-150 flex items-center justify-center p-4 bg-black/70 backdrop-blur-sm">
            ...
            >
              ...
              <h3 className="text-base font-black">Live Queue Radar</h3>
              ...
              <div className="my-4 space-y-2 text-xs">
                <div className="p-3 rounded-xl bg-slate-50 dark:bg-slate-800/60 flex justify-between">
                  ...
                  <span className="font-bold text-emerald-500">Token #35</span>
                </div>
                ...
                <div className="p-3 rounded-xl bg-slate-50 dark:bg-slate-800/60 flex justify-between">
                  <span className="text-slate-400">Estimated Scale Entry:</span>

                  <span className="font-bold text-amber-500">~45 Minutes</span>
                </div>
              </div>
              ...
              <div className="space-y-3 text-xs">
                <div>
                  ...
                  <select className="w-full p-2.5 rounded-xl bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 font-bold">
                    <option>Paddy (PR-126 / Basmati)</option>

                    <option>Wheat (Sharbati / Lok-1)</option>

                    <option>Maize (Hybrid Yellow)</option>
                ...
                <div>
                  ...
                  <select className="w-full p-2.5 rounded-xl bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 font-bold">
                    <option>10:00 – 11:00 AM (3 slots remaining)</option>

                    <option>08:00 – 09:00 AM (12 slots remaining)</option>

                    <option>02:00 – 03:00 PM (15 slots remaining)</option>
                  </select>
                </div>
              </div>
        ...
        {showLogoutModal && (
          <div className="fixed inset-0 z-150 flex items-center justify-center p-4 bg-black/70 backdrop-blur-sm">
            ...
            >
              ...
              <h3 className="text-base font-black">Confirm Logout</h3>

              <p className="text-xs text-slate-500 dark:text-slate-400 mt-1">
                Are you sure you want to log out of your AGRINEX farmer account?
              </p>
