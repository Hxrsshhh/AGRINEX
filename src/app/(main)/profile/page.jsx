      ...
      <main className="w-full p-4 sm:p-6 lg:p-8">
          ...
          <div className="relative p-5 sm:p-7">
            <div className="flex flex-col md:flex-row md:items-center gap-6">
              ...
              <div className="flex-1 text-center md:text-left">
                ...
                <p className="text-xs text-slate-400 mt-2">AGRINEX Farmer ID</p>
        ...
        <div className="grid lg:grid-cols-2 gap-6 mt-6">
          ...
          >
            ...
            <InfoRow label="Father's Name" value={farmer.fatherName} />

            <InfoRow label="Mobile Number" value={farmer.phone} icon={Phone} />

            <InfoRow label="Email Address" value={farmer.email} icon={Mail} />
          </ProfileCard>
          ...
          >
            ...
            <InfoRow label="Soil Type" value={farmer.soilType} />
          ...
          >
            ...
            <div className="p-4 rounded-2xl bg-emerald-500/5 border border-emerald-500/15">
              <div className="flex items-center justify-between gap-3">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-xs font-black">e-KYC Verification</p>
            ...
            <InfoRow label="e-KYC Status" value={farmer.ekycStatus} green />
          </ProfileCard>
        </div>
        ...
        <div className="mt-5 p-4 rounded-2xl bg-slate-100 dark:bg-slate-900/70 border border-slate-200 dark:border-slate-800 flex items-start gap-3">
          ...
          <div>
            <p className="text-xs font-black">Verified information</p>

            <p className="text-[10px] leading-relaxed text-slate-500 dark:text-slate-400 mt-1">
              Government verification details such as Aadhaar and e-KYC status
              are protected and cannot be directly modified from AGRINEX.
              Contact the appropriate authority if corrections are required.
            </p>
          </div>
        </div>
      </main>
...
function InfoRow({ label, value, icon: Icon, green = false }) {
  return (
    <div className="flex items-center justify-between gap-4 p-3.5 rounded-2xl bg-slate-50 dark:bg-slate-800/50 border border-transparent hover:border-slate-200 dark:hover:border-slate-700 transition-colors">
      ...
      <span
        className={`text-xs font-black text-right wrap-break-word ${
...
function QuickStat({ label, value, icon: Icon, green = false }) {
  return (
    <div className="p-3.5 rounded-2xl bg-slate-50 dark:bg-slate-800/60 border border-slate-200 dark:border-slate-700">
      ...
      <p
        className={`mt-2 text-xs font-black ${green ? "text-emerald-500" : ""}`}
      >
        {value}
      </p>
    </div>
