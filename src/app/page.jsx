      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between">
          ...
          <div className="hidden sm:flex items-center gap-2">
            ...
            <Link
              href="/signup"
              className="px-5 py-2.5 rounded-xl bg-linear-to-r from-emerald-600 via-teal-600 to-lime-600 text-white text-xs font-black shadow-lg shadow-emerald-600/20 hover:shadow-emerald-500/40 hover:scale-[1.02] transition-all flex items-center gap-1.5"
            >
              Get Started
          ...
          >
            <div className="flex flex-col gap-1 pt-3">
              ...
              <div className="mt-3 pt-3 border-t border-slate-200 dark:border-slate-800 grid grid-cols-2 gap-2">
                ...
                <Link
                  href="/signup"
                  className="py-3 rounded-xl bg-linear-to-r from-emerald-600 to-lime-600 text-white text-center text-xs font-black"
                >
                  Get Started
                </Link>
              </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        <div className="grid lg:grid-cols-12 gap-14 items-center">
          ...
          >
            ...
            >
              AGRINEX connects farmers with procurement centres through digital
              slot booking, live queue tracking, transparent procurement status
              and payment updates.
            </motion.p>
              ...
              <div className="rounded-[28px] p-[1px] bg-gradient-to-br from-emerald-500/50 via-teal-500/20 to-lime-500/50 shadow-2xl shadow-emerald-950/10">
                <div className="rounded-[27px] bg-white dark:bg-[#0c131a] p-5 sm:p-6">
                  ...
                  <div className="flex items-center justify-between pb-4 border-b border-slate-200 dark:border-slate-800">
                    ...
                    >
                      <RefreshCw
                        className={`w-3.5 h-3.5 ${syncing ? "animate-spin text-emerald-500" : ""
                          }`}
                      />
                      SYNC
                    </button>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="mt-4 text-sm leading-relaxed text-slate-500 dark:text-slate-400 max-w-lg">
              AGRINEX turns the traditional waiting line into a digital queue.
              Farmers can check their token, current position and estimated
              waiting time from their phone.
            </p>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3">
            {stages.map((stage, index) => {
              ...
              return (
                <div
                  key={stage.title}
                  className={`p-4 rounded-2xl border text-center ${completed
                ...
                >
                  <div
                    className={`mx-auto w-9 h-9 rounded-full flex items-center justify-center ${completed
                  ...
                  <p
                    className={`mt-1 text-[9px] ${completed
                      ? "text-emerald-500"
                      : active
                        ? "text-amber-500"
                        : "text-slate-400"
            ...
            return (
              ...
              >
                ...
                >
                  ...
                  <ChevronRight
                    className={`w-4 h-4 shrink-0 text-emerald-500 transition-transform ${active ? "rotate-90" : ""
                      }`}
                  />
                </button>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="col-span-2 md:col-span-3 lg:col-span-1">
            <Link href="/" className="inline-flex items-center gap-2.5">
              ...
              <span className="text-xl font-black">
                AGRI
                <span className="text-emerald-500">NEX</span>
              </span>
            </Link>

            <p className="mt-4 text-xs leading-relaxed text-slate-500 dark:text-slate-400 max-w-xs">
              Digital procurement management for farmers and procurement centres
              — designed to reduce waiting and improve transparency.
            </p>
        ...
        <div className="py-6 flex flex-col sm:flex-row items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-4 text-[10px] text-slate-500">
            <a href="#privacy" className="hover:text-emerald-500">
              Privacy
            </a>

            <span>•</span>

            <a href="#terms" className="hover:text-emerald-500">
              Terms
            </a>
  ...
  return (
    <div className="p-4 rounded-2xl bg-slate-50 dark:bg-slate-800/60 border border-slate-200 dark:border-slate-800 text-center">
      <div className="flex items-center justify-center gap-1.5 text-[9px] uppercase tracking-wider font-black text-slate-400">
        <Icon
          className={`w-3.5 h-3.5 ${amber ? "text-amber-500" : "text-emerald-500"
            }`}
        />
      ...
      <p className={`mt-1 text-xl font-black ${amber ? "text-amber-500" : ""}`}>
        {value}
      </p>
    </div>
  );
...
function CentreMetric({ label, value, amber = false }) {
  return (
    <div className="flex items-center justify-between px-3 py-2.5 rounded-xl bg-slate-50 dark:bg-slate-800/50">
      ...
      <span className={`text-xs font-black ${amber ? "text-amber-500" : ""}`}>
        {value}
      </span>
    </div>
  );
