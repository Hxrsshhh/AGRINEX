...
const officerSchema = new mongoose.Schema(
  {
    ...
    role: { type: String, enum: ["OFFICER"], default: "OFFICER", required: true, index: true },
    isActive: { type: Boolean, default: true, index: true },
    designation: { type: String, enum: ["CENTRE_MANAGER"], required: true, index: true },
    officerCentre: { type: mongoose.Schema.Types.ObjectId, ref: "ProcurementCentre", default: null, index: true },
    preferredLanguage: {
      type: String,
